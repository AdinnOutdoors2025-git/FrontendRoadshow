...
import Ad1OrdersManagement from "./ad1OrdersManagement";
    ...
    <span></span>
        ...
        <div className="AdminPanelHome-contentLeft">
          ...
          {activeVehicleMenu === "new_vehicles" && (
            <div className="subcategory-list pl-6">
              <div
                className={`subcategory-item ${activeSubProduct === "Orders Management" ? "active" : ""}`}
                onClick={() => {
                  setActiveSubProduct("Orders Management");
                }}
              >
                Orders Management
              </div>
        ...
        {activeSubProduct === "New Entry Vehicles" && (
          <div
            ...
            style={{
              display:
                activeSubProduct === "New Entry Vehicles" ? "block" : "none",
            }}
          >
        ...
        {activeSubProduct === "New Vehicles Info" && (
          <div
            ...
            style={{
              display:
                activeSubProduct === "New Vehicles Info" ? "block" : "none",
            }}
          >
        ...
        {activeSubProduct === "Vehicles Info" && (
          ...
          >
            ...
            {activeSubProduct === "Orders Management" && (
          <div
            className="pl-6"
            id="admanager"
            style={{
              display: activeSubProduct === "Orders Management" ? "block" : "none",
            }}
          >
            <Ad1OrdersManagement editVehicle={editVehicle} />
