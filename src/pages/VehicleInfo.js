...
//FORMATTED NUMBER 
import { formatWithCommas, formatIndianNumber, formatNumber } from "../components/FormattedNumber";
            ...
            filteredVehicles.map((vehicle) => (
              ...
              >
                ...
                <div className="vehicle-right">
                  <div
                    className={`status-badge ${vehicle.remainingCount === 0
                      ? "unavailable blinking"
                ...
                <table className="neoContentsMain">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="newContentLeft">
                        🟢 {formatWithCommas(selectedVehicle.availableCount || 0)}
                      </td>
                    </tr>
                    <tr>
                      <td className="newContentLeft">Unavailable Count</td>
                      <td className="newContentLeft">
                        🔴 {formatWithCommas(selectedVehicle.unavailableCount || 0)}
                      </td>
                    </tr>
                    <tr>
                      <td className="newContentLeft">Remaining Count</td>
                      <td className="newContentLeft">
                        ✅ {formatWithCommas(selectedVehicle.remainingCount || 0)}
                      </td>
                    </tr>
