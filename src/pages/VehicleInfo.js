...
function VehicleInfo() {
  ...
  const filteredVehicles = vehicles
    .filter((v) => {
      ...
      const matchesSearch =
        cleanRawNumber.includes(cleanSearch) ||
        formattedNumber.includes(searchTerm.toLowerCase()) ||
        rawNumber.includes(searchTerm.toLowerCase()) ||
  ...
  return (
    <div className={`availability-page ${statusMood}`}>
      ...
      <div
        className={`liquid-dashboard-header ${isScrolled ? "scrolled" : ""}`}
      >
        {/* Count Badges */}
          ...
          <div className="desktop-view">
            ...
            <div className="capsule-dropdowns">
              ...
              {(selectedLocation !== "all" ||
                ...
                selectedAvailability !== "all") && (
                <button
                  className="desktop-clear-filters"
                  onClick={handleClearFilters}
                >
                  Clear Filters
                </button>
