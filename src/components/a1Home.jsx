...
//             {/* Roadshow banner*/}
//             <div>
//                 <img src='./images/RoadshowBanner.png' className='rdshowHomeBanner'></img>
//             </div>
...
//                     Available Vehicles
//                 </div>
//                 <div className='rdAvailableContentMain' onClick={()=>navigate('/vehicleTypesDetails')}>
//                     {
//                         availableVehicle.map((vehicle) => (
//                             <div key={vehicle.id} className='rdAvailContentInside'>
//                                 <div>
//                                     {/* Vehicle Image */}
...
//                                         <div className='rdAvailVehRate'>₹ {vehicle.ratePerDay.toLocaleString()}/Per Day</div>
...
//                                         {/* View Details Button */}
//                                         <button className='rdAvailVehBtn' onClick={()=>navigate('/vehicleTypesDetails')} >
//                                             View Details
//                                         </button>
//                                     </div>
//                                 </div>
...
//                     <img src='./images/LiveRoadActivityImg.png' className='LiveRdShowContentRight'></img>
//                 </div>
//             </div>
...
//                         <div>
//                             <img src='./images/HowItWorksImg1.png' className='img-fluid howItWorksImg' alt='RTO Certified' />
//                             <div className='whyChooseContent howItWorksContent'>Select</div>
//                         </div>
//                     </div>
//                     <div className='col-md-4 col-sm-6 text-center '>
//                         <div>
//                             <img src='./images/HowItWorksImg2.png' className='img-fluid howItWorksImg' alt='One-Stop Solution' />
//                             <div className='whyChooseContent howItWorksContent'>Book</div>
//                         </div>
//                     </div>
//                     <div className='col-md-4 col-sm-6 text-center '>
//                         <div>
//                             <img src='./images/HowItWorksImg3.png' className='img-fluid howItWorksImg' alt='24/7 Support' />
...
//     const { setSelectedVehicle } = useVehicle(); // Add this
...
//         //     ,{
//         //     state :{selectedVehicle : vehicleData}
//         // }
//     )
//     }
//     if (isLoading) {
...
//                     {
//                         vehicleData.map((vehicle) => (
//                             <div key={vehicle._id} className='rdAvailContentInside'>
//                                 <div>
//                                     {/* Vehicle Image */}
//                                     <div className='rdAvailVehImg'>
//                                         <img src={vehicle.image} alt={vehicle.name} className='rdAvailVehImg' />
