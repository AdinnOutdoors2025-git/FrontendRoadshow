...
//                 <div className='NavRoadShowLogo' onClick={()=>navigate('/')}  > <img src='/images/RoadShowLogo.png' className='NavRoadShowLogo'></img> </div>

//                 {/* <div className='rdshowNavContentMain' >
//                     <div className='NavbarIcon1 rdshowNavInsideContent'>
//                         <div> <img src='/images/NavbarIcon1.png' className='NavbarIcon1'></img> </div>
//                         <div> Home</div>
//                     </div>
//                      <div className='NavbarIcon1 rdshowNavInsideContent'>
//                         <div> <img src='/images/NavbarIcon2.png' className='NavbarIcon1'></img> </div>
//                         <div> About Us </div>
//                     </div>
//                      <div className='NavbarIcon1 rdshowNavInsideContent'>
//                         <div> <img src='/images/NavbarIcon3.png' className='NavbarIcon1'></img> </div>
//                         <div> Projects</div>
//                     </div>
//                 </div> */}
//                 <nav class=" rdNavContentMain">
//                     <ul>
//                         <li className='rdNavContentInside' > <img src='/images/NavbarIcon1.png' className='NavbarIcon1'></img> <a onClick={()=>navigate('/')} style={{cursor:'pointer'}}>Home</a></li>
//                         <li className='rdNavContentInside'> <img src='/images/NavbarIcon2.png' className='NavbarIcon1'></img> <a onClick={()=>navigate('/')} style={{cursor:'pointer'}} >About Us</a></li>
//                         <li className='rdNavContentInside'> <img src='/images/NavbarIcon3.png' className='NavbarIcon1'></img> <a onClick={()=>navigate('/')} style={{cursor:'pointer'}} >Projects</a></li>
//                     </ul>
//                 </nav>

//                 <div className='NavbarIcon1'>
//                     <img src='/images/NavbarIcon4Hamburger.png' className='NavbarIcon1'></img>
//                 </div>
//             </div>
...
//     const { openLogin, closeLogin, isLoginOpen, user, logoutUser, loginUser, employeeUser, logoutEmployee } = useLogin();
...
//                     <ul>
//                         <li className='rdNavContentInside'> 
...
//                             <a onClick={() => navigate('/')} style={{ cursor: 'pointer' }}>About Us</a>
//                         </li>
//                         <li className='rdNavContentInside'> 
//                             <img src='/images/NavbarIcon3.png' className='NavbarIcon1' alt='Projects' /> 
//                             <a onClick={() => navigate('/')} style={{ cursor: 'pointer' }}>Projects</a>
//                         </li>
//                     </ul>
//                 </nav>
...
//                                 </div>
//                                 <div> 
//                                     {employeeUser ? 'Employee Logout' : 'Employee Log In'} 
//                                     {employeeUser && <span style={{fontSize: '12px', color: 'green'}}> ✓</span>}
//                                 </div>
//                             </div>
